...
export const routes: Routes = [
  ...
  { path: 'politicas-y-privacidad', loadComponent: () => import('./pages/politicas-y-privacidad/politicas-y-privacidad.component').then(m => m.PoliticasYPrivacidadComponent) },
  { path: 'centro-de-ayuda', loadComponent: () => import('./pages/centro-de-ayuda/centro-de-ayuda.component').then(m => m.CentroDeAyudaComponent) },
  { path: 'seguridad', loadComponent: () => import('./pages/seguridad/seguridad.component').then(m => m.SeguridadComponent) },
